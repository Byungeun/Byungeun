...
# 📝 이력
> ## 1. '14년 ~ '25년 : 대한민국 육군 장교 복무 ('25년 2월 전역) 
...
> ## 4. '24~'25년 (10개월): 'MS 클라우드 기반 사이버 정보 보안 전문교육' 수료 
> - 내용 : 리눅스, 네트워크, 정보 보안, 클라우드(Azure), 취약점 진단, 모의해킹
> ## 5. 현재: XR Cloud 기술팀 근무  
> - 내용 : 클라우드 플랫폼 운영 총괄, GPU 서버 설치 및 유지보수, 사내 프로그램 개발 
<br />
